                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('moscowpoly.work') }}">
                            ...
                            <p class="text-info">Иногда сервер не засчитывает бросок кубика (не моя вина), хотя награда выпадает и ее даже можно взять. Поэтому иногда
                            фактическое количество бросков может быть даже больше потраченных кубиков.</p>
