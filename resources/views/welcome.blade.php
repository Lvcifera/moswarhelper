...
@section('content')
    <div class="jumbotron">
        ...
        <p class="lead">Хочешь купить и открыть 100500 зубных ящиков одним нажатием кнопки? Хочешь бросить миллион кубиков
            ...
            но хочешь сыграть на все моментально? А администрация никогда не сделает это внутри игры...?
        </p>
        ...
        <div class="row">
                ...
                <div class="list-group">
                    <a class="list-group-item list-group-item-action flex-column align-items-start active">
                        <div class="d-flex w-100 justify-content-between">
                            <h5 class="mb-1">Для всего вышеперечисленного уже давным давно есть скрипты. Зачем какое-то приложение?</h5>
                        </div>
                    </a>
            ...
            <div class="col-6">
                <div class="list-group">
                    <a class="list-group-item list-group-item-action flex-column align-items-start active">
                        <div class="d-flex w-100 justify-content-between">
                            <h5 class="mb-1">Всем известный бот уже умеет играть с гадалкой и открывать зубные ящики!</h5>
                        </div>
                    </a>
                    <a class="list-group-item list-group-item-action flex-column align-items-start">
                        <p class="mb-1">
            ...
            <div class="col-6">
                ...
                <div class="list-group">
                    <a class="list-group-item list-group-item-action flex-column align-items-start active">
                        <div class="d-flex w-100 justify-content-between">
                            <h5 class="mb-1">Не слишком ли дорого за такое смешное количество функций? Бот стоит 150 рублей
            ...
            <div class="col-6">
                ...
                <div class="list-group">
                    <a class="list-group-item list-group-item-action flex-column align-items-start active">
                        <div class="d-flex w-100 justify-content-between">
                            <h5 class="mb-1">А не ворует ли приложение пароли? Очень боязно вводить данные где попало</h5>
                        </div>
                    </a>
                    <a class="list-group-item list-group-item-action flex-column align-items-start">
                        <p class="mb-1">
